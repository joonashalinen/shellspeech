...
export { Channel, DiscreetRoom, DMessage, Hotel, IMediator, Mediator, IMessenger, IRoom, LoopbackMessenger, MessageFactory, MessagePipe, MessengerClass, ProxyMessenger, Room, SyncMessenger };
